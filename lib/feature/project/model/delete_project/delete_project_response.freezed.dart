...
part of 'delete_project_response.dart';
...
class _$_DeleteProjectResponse implements _DeleteProjectResponse {
  const _$_DeleteProjectResponse(
  ...
  @override
  String toString() {
    return 'DeleteProjectResponse(success: $success, message: $message)';
  }
...
abstract class _DeleteProjectResponse implements DeleteProjectResponse {
  const factory _DeleteProjectResponse(
      {required final bool success,
      required final String message}) = _$_DeleteProjectResponse;
